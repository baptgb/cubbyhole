...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/annotations', false);
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'cubbyhole_api', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_c7640d5889ebc3a579aa33410f078f6bbc60dfc44f1b31880f356576088501b9');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_c7640d5889ebc3a579aa33410f078f6bbc60dfc44f1b31880f356576088501b9');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_c7640d5889ebc3a579aa33410f078f6bbc60dfc44f1b31880f356576088501b9');
        ...
        $e->setProxyDir('/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'America/Montreal', true);
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/baptiste/Projects/cubbyhole/api/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/baptiste/Projects/cubbyhole/api/app/../web', false);
    }
    ...
    protected function getJmsSerializer_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/jms_serializer'));
        return $instance;
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod',
            ...
            'session.save_path' => '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/sessions',
            ...
            'router.resource' => '/Users/baptiste/Projects/cubbyhole/api/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => '/Users/baptiste/Projects/cubbyhole/api/app/cache/prod/fos_rest',
