...
namespace Proxies\__CG__\Cubbyhole\ApiBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Plan extends \Cubbyhole\ApiBundle\Entity\Plan implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'duration', 'space', 'bandwidth', 'users');
        }
    ...
    public function setBandwidth($bandwidth)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBandwidth', array($bandwidth));
    ...
    public function getBandwidth()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBandwidth', array());
